...
export default function ContactPage() {
  ...
  return (
    <div className="bg-white min-h-screen text-gray-900 overflow-x-hidden">
      ...
      {/* ══════════════════════ HERO SECTION ══════════════════════ */}
      <section className="relative pt-32 pb-20 bg-[#0B1E3D] overflow-hidden">
      ...
      <section className="max-w-6xl mx-auto px-4 -mt-10 relative z-10">
        <div className="bg-white border-t-4 border-t-[#F5A623] border-x border-b border-gray-100 rounded-xl p-4 md:p-5 shadow-md shadow-gray-200/50">
          <div className="grid grid-cols-4 gap-1 divide-x divide-gray-150">
            {[
              { label: 'Call Us', val: '+91 98765 43210', shortVal: 'Call', desc: 'Mon - Sat: 9 AM - 7 PM', icon: <Phone className="w-3.5 h-3.5 md:w-5 md:h-5" />, bg: 'bg-[#F5A623]/10 text-[#F5A623] group-hover:bg-[#F5A623]/20', href: 'tel:+919876543210' },
              { label: 'WhatsApp', val: 'Chat with Expert', shortVal: 'Chat', desc: 'Instant support desk', icon: <MessageSquare className="w-3.5 h-3.5 md:w-5 md:h-5" />, bg: 'bg-green-500/10 text-green-600 group-hover:bg-green-500/20', href: 'https://wa.me/919876543210' },
              { label: 'Email Us', val: 'info@enfiniteenergy.com', shortVal: 'Email', desc: 'Response in 4 hours', icon: <Mail className="w-3.5 h-3.5 md:w-5 md:h-5" />, bg: 'bg-blue-500/10 text-blue-600 group-hover:bg-blue-500/20', href: 'mailto:info@enfiniteenergy.com' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap gap-2 mb-4 bg-white border border-gray-100 p-2 rounded-xl shadow-sm max-w-2xl">
            {[
              ...
              { id: 'noida', label: 'Noida HQ (NCR)', address: 'Plot No. 45, Sector 63, Noida, Uttar Pradesh – 201301', tel: '+91 98765 43210', map: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3503.7744783307613!2d77.3789428!3d28.6065415!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce561c28c8959%3A0xc07a72d3fbd3f392!2sNoida%20Sector%2063!5e0!3m2!1sen!2sin!4v1700000000000' }
            ].map((tab) => (
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-white/60 mt-0.5">info@enfiniteenergy.com</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5 shadow-lg">
              ...
              <div className="space-y-3.5">
                {[
                  ...
                  { icon: <PhoneCall className="w-4 h-4 text-green-400"/>, title: 'WhatsApp Chat', desc: 'Get instant replies on WhatsApp', link: 'https://wa.me/919876543210' },
      ...
      <section className="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-gray-150">
