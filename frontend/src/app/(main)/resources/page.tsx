...
export default function ResourcesPage() {
  ...
  return (
    <div className="bg-[#FAFBFD] min-h-screen pt-10">
      ...
      <section className="py-8 px-4 sm:px-4 lg:px-6 max-w-7xl mx-auto">
      ...
      {/* 2. Blog Grid */}
      <section className="py-6 px-4 sm:px-4 lg:px-6 max-w-7xl mx-auto">
      ...
      <section className="py-12 px-4 sm:px-4 lg:px-6 max-w-7xl mx-auto mt-10">
      ...
      {/* 4. FAQs Accordion */}
      <section className="py-8 px-4 sm:px-4 lg:px-6 max-w-4xl mx-auto scroll-mt-12">
      ...
      <section className="py-10 px-4 sm:px-4 lg:px-6 bg-white border-t border-gray-100">
